# 本文件复制自赛题材料包提供的评估程序 code/contest_io.py，
...
def run_problem_cli(problem, argv=None):
    ...
    from .fe_evaluation_validation import read_evaluation_config
    settings = read_evaluation_config(str(config_path))
    capacity = settings['capacity']
    bandwidth = settings['bandwidth']

    if problem == 1:
        from .fe_multicore_cut_evaluate_problem_1 import evaluate_scene_a, read_scene_a_config
        ...
        from .fe_multicore_cut_evaluate_problem_2 import evaluate_scene_b, read_scene_b_config
        ...
        from .fe_multicore_cut_evaluate_problem_3 import (
